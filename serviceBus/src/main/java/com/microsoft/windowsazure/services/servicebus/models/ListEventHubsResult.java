...
public class ListEventHubsResult {
     ...
     *
     * @return A <code>List</code> of {@link com.microsoft.windowsazure.services.servicebus.models.EventHubInfo} objects that represent
     ...
     *
     * @param items
     *            A <code>List</code> object that contains the {@link com.microsoft.windowsazure.services.servicebus.models.EventHubInfo}
